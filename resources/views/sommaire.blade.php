        ...
        <div id="menuGauche">
            <div id="infosUtil">
               ...
               <ul id="menuList">
                  ...
                  <li class="smenu">
                    <a href="{{ route('chemin_test') }}" title="En construction">En construction</a>
                  </li>
                  <li class="smenu">
                    <a href="{{ route('chemin_gestionMdp') }}" title="Modification du mot de passe">Changer mon mot de passe</a>
                  </li>
                  <li class="smenu">
